<template>
  <div>
    ...
    <el-dialog
    title="分配角色"
    :visible.sync="setRolesialogVisible"
    width="50%"
  ...
  <span slot="footer" class="dialog-footer">
    <el-button @click="setRolesialogVisible = false">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    async setRole (userInfo) {
      ...
      this.setRolesialogVisible = true
    },
    async saveRoleInfo () {
      ...
      this.getUserList()
      this.setRolesialogVisible = false
    },
    setRoleDialogClose () {
      this.selectedRoleID = ''
      this.userInfo = {}
